...
## Этап 1: Инфраструктура и качество кода
...
### Шаг 1.1 — Создание `.editorconfig` в корне решения
...
### Шаг 1.2 — Подключение Roslyn-анализаторов и StyleCop
...
### Шаг 1.3 — Подавление исторических предупреждений анализаторов
...
### Шаг 1.4 — Удаление неиспользуемого кода (YAGNI)
...
### Шаг 2.1 — Создание интерфейсов для Core-сервисов и Infrastructure
...
### Шаг 2.2 — Реализация интерфейсов в существующих классах и разрыв циклической зависимости
