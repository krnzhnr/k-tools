...
from app.ui.muxing_table_widget import MuxingTableWidget, NaturalSortTableWidgetItem
...
def test_natural_sort_key():
    ...
    assert NaturalSortTableWidgetItem._natural_key("file2.mkv") < NaturalSortTableWidgetItem._natural_key("file10.mkv")
    assert NaturalSortTableWidgetItem._natural_key("file1.mkv") < NaturalSortTableWidgetItem._natural_key("file2.mkv")
...
def test_muxing_table_grouping(qtbot, mocker):
    ...
    assert "episode1.rus.srt" in table.item(row1, 2).text()
