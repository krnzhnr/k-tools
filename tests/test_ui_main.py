...
def test_main_window_init(qtbot, mocker):
    mocker.patch("app.core.resource_utils.get_resource_path", return_value="icon.ico")
...
def test_work_panel_execution_start(qtbot, mocker):
    ...
    mocker.patch.object(page._file_list, "get_file_paths", return_value=[Path("test.tmp")])
