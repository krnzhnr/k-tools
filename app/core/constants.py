...
class ScriptMetadata:
    ...
    # Аудио
    AUDIO_CONVERTER_NAME = "Кодирование аудио"
    AUDIO_CONVERTER_DESC = (
        "Перекодирование аудио в QAAC, AAC, FLAC, WAV, "
    ...
    AUDIO_SPEED_DESC = (
        "Изменение скорости/тона аудио (PAL ↔ NTSC) "
        "с помощью eac3to."
    )

    AUDIO_SPLIT_NAME = "Разделение каналов"
    AUDIO_SPLIT_DESC = (
        "Разделение многоканального аудио на моно-WAV файлы "
        "с опциональной склейкой в стереопары"
    )

    # Видео
    CONTAINER_CONV_NAME = "Конвертация контейнера"
    CONTAINER_CONV_DESC = (
        "Перемещение видео/аудио потоков в другой "
        "контейнер без перекодирования"
    )

    METADATA_CLEAN_NAME = "Очистка метаданных"
    METADATA_CLEAN_DESC = (
        "Удаление метаданных из видеофайлов с сохранением "
        "оригинального качества"
    )

    VIDEO_PROCESSOR_NAME = "Кодирование видео"
    VIDEO_PROCESSOR_DESC = (
        "Кодирование видео: изменение формата, вшивание "
        "субтитров, фильтрация тегов и настройка звука"
    )

    # Контейнеры
    MUXER_NAME = "Сборка MKV"
    MUXER_DESC = (
        "Сборка контейнера MKV из отдельных потоков видео, "
        "аудио и субтитров с сопоставлением по имени"
    )
    ...
    TRACK_EXTR_NAME = "Разборка контейнера"
    TRACK_EXTR_DESC = (
...
STATUS_COLORS = {
    ...
    "warning": "#F5A623",  # Желтый (предупреждение)
}
